...
import student, course, instructor
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tblRegistration.setColumnCount(3)
        ...
        self.tblAttendance.setColumnCount(7)
    ...
    def btnEditStudent_clicked(self):
        currentRow = self.tblStudent.currentRow()
        ...
        listValues = []
        listValues.append(self.tblStudent.item(currentRow, 0).text())
        listValues.append(self.tblStudent.item(currentRow, 1).text())
        listValues.append(self.tblStudent.item(currentRow, 2).text())
        listValues.append(self.tblStudent.item(currentRow, 3).text())

        original_student_ID = listValues[0]

        listValues = self.openDialog(student, listValues)
        if listValues is not None:
            self.updateStudent(listValues, original_student_ID)
            self.refreshStudent()
            # TODO:Make sure the student in other tables also change
    ...
    def btnDeleteStudent_clicked(self):
        ...
        if answer == QMessageBox.StandardButton.Yes:
            ID = self.tblStudent.item(currentRow, 0).text()
    ...
    def btnEditCourse_clicked(self):
        currentRow = self.tblCourse.currentRow()
        ...
        listValues = []
        listValues.append(self.tblCourse.item(currentRow, 0).text())
        listValues.append(self.tblCourse.item(currentRow, 1).text())

        original_course_ID = listValues[0]

        listValues = self.openDialog(course, listValues)
        if listValues is not None:
            self.updateCourse(listValues, original_course_ID)
            self.refreshCourse()
            # TODO:Make sure the course in other tables also change
    ...
    def btnDeleteCourse_clicked(self):
        ...
        # Check if user clicked Yes button
        if answer == QMessageBox.StandardButton.Yes:
            ID = self.tblCourse.item(currentRow, 0).text()
    ...
    def btnEditInstructor_clicked(self):
        currentRow = self.tblInstructor.currentRow()
        ...
        listValues = []
        listValues.append(self.tblInstructor.item(currentRow, 0).text())
        listValues.append(self.tblInstructor.item(currentRow, 1).text())

        original_instructor_ID = listValues[0]

        listValues = self.openDialog(instructor, listValues)
        if listValues is not None:
            self.updateInstructor(listValues, original_instructor_ID)
            self.refreshInstructor()
            # TODO:Make sure the instructor in other tables also change
    ...
    def btnDeleteInstructor_clicked(self):
        ...
        # Check if user clicked Yes button
        if answer == QMessageBox.StandardButton.Yes:
            ID = self.tblInstructor.item(currentRow, 0).text()

            # Delete from database
            self.deleteInstructor(ID)
    ...
    def insertStudent(self, a_listValues):
        ...
        cursor = self.execute_query("Insert Into student (student_id, student_first_name, student_last_name, student_email) "
    ...
    def updateStudent(self, a_listValues, original_student_ID):
        ...
        cursor = self.execute_query("Update student "
                                    ...
                                    "Where student_ID = %s",
                                    [a_listValues[0], a_listValues[1], a_listValues[2], a_listValues[3], original_student_ID])
        self.commit_and_close(cursor)
