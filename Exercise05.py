...
##################### End UI Generation ###################
    ...
    def setValues(self):
        ...
        self.cmbCategory.setCurrent(self.listValues[0])
        self.txtExpenseDate.setText(self.listValues[1])
        self.txtExpense.setText(self.listValues[2])
        self.txtAmount.setText(self.listValues[3])
        self.txtNotes.setText(self.listValues[4])

    def getValues(self):
        listResult = []
        listResult.append(self.cmbCategory.currentText())
        listResult.append(self.txtExpenseDate.text())
